        ...
        <div className="mt-10">
            <footer className="footer p-10 bg-base-200 text-base-content">
                ...
                <form onSubmit={submitFeedback}>
                    <header className="footer-title">Review Us</header>
                    <fieldset className="form-control w-80">
                        <label className="label">
                            <span className="label-text">Write your thoughts about us:</span>
                        </label>
                        <div >
                            <div className="join">
                            ...
                            <div>
                                <h2>Today: {moment().format('lll')}</h2>
                            </div>

                            {/* ratting */}
                            <div className=" mt-5 items-center flex gap-2">
                                ...
                                <div className="text-lg">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <span
                                            ...
                                            style={{ cursor: 'pointer', fontSize: 32, color: star <= rate ? '#EEC833' : 'gray' }}
                                        >
                                            ★
                                        </span>
                                    ))}
