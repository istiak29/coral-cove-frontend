                    ...
                    <div key={i}>
                        <div className="card card-compact bg-base-100 shadow-xl">
                            ...
                            <div className="card-body">
                                <h2 className="card-title">{transport.vehicle_type_title}</h2>
                                ...
                                <div className="card-actions justify-end">
                                    <button onClick={() => handleBook(transport.vehicle_type_title, transport.type, transport.price)} type="submit" className="btn form-control btn-primary join-item">Book</button>
                                </div>
                            </div>
                        </div>
                    </div>
